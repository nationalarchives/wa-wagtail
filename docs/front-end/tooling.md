...
`svgo -r -f ukgwa/static_src/images`
...
`svgo ukgwa/static_src/images/[your-file.svg] -o ./ukgwa/static_src/optimised_images`
...
`imagemin ukgwa/static_src/images/\*.{jpg,jpeg} --plugin=mozjpeg --out-dir=./ukgwa/static_src/images`
...
`imagemin ukgwa/static_src/images/[your-file.jpg] --plugin=mozjpeg --out-dir=./ukgwa/static_src/optimised_images`
