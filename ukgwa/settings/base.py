"""
Django settings for ukgwa project.
"""
...
INSTALLED_APPS = [
    ...
    #   SCOUT_NAME="ukgwa-(staging|production)"
    #
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "ukgwa.core.context_processors.global_vars",
            ],
            "builtins": [
...
WSGI_APPLICATION = "ukgwa.wsgi.application"
...
DATABASES = {
    "default": dj_database_url.config(conn_max_age=600, default="postgres:///ukgwa")
}
...
if REDIS_URL:
    ...
    if REDIS_URL.startswith("rediss"):
        ...
        # Also disable hostname checking to match the cert_reqs=None setting
...
if "AWS_STORAGE_BUCKET_NAME" in env:
    ...
    # Note: wagtail_storages is not included as it requires wagtail.documents
...
CSRF_FAILURE_VIEW = "ukgwa.utils.views.csrf_failure"
...
# https://github.com/torchbox/django-basic-auth-ip-whitelist
...
WAGTAIL_SITE_NAME = "UK Government Web Archive"
...
WAGTAIL_PASSWORD_REQUIRED_TEMPLATE = "pages/wagtail/password_required.html"
