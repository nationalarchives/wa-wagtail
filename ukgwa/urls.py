...
from ukgwa.utils.cache import get_default_cache_control_decorator
...
urlpatterns = (
    ...
    + [
        ...
        # Wagtail cache-control is set on the page models's serve method
        path("", include(wagtail_urls)),
    ]
)

# Error handlers
handler404 = "ukgwa.utils.views.page_not_found"
handler500 = "ukgwa.utils.views.server_error"
