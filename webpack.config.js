    ...
    plugins: [
        new CopyPlugin({
            patterns: [
                ...
                {
                    // Copy TNA Frontend print styles
                    from: 'node_modules/@nationalarchives/frontend/nationalarchives/print.css',
                    to: path.resolve(
                        `./${projectRoot}/static_compiled/css/print.css`,
                    ),
                },
            ],
        }),
